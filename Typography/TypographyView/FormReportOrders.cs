...
namespace TypographyView
{
    public partial class FormReportOrders : Form
    {
        ...
        public FormReportOrders(IReportLogic logic)
        {
            ...
            reportViewer.LocalReport.LoadReportDefinition(new FileStream("C:\\Users\\Юрий\\OneDrive\\Desktop\\4\\Typography\\TypographyView\\ReportOrders.rdlc", FileMode.Open));
        Controls.Clear();
